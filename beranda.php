      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-orange">
            ...
            <a href="lahir_tampil.php" class="small-box-footer">Lihat Data <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-aqua">
            ...
            <a href="lurah_add.php" class="small-box-footer">Lihat Data<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-black">
            <div class="inner">
              <h3><?php echo $user; ?></h3>
              <p>Data Total Admin</p>
            </div>
            <div class="icon">
                  <i class="ion ion-person-add"></i>
            </div>
            <a href="user_add.php" class="small-box-footer">Lihat Data<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
