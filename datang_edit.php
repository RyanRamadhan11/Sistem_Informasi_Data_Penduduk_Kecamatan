...
$sqlku = mysqli_query($konek,"SELECT * FROM v_datang WHERE kode='$id '");
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="datang_add.php">Tambah</a> | <a href="datang_tampil.php">Lihat Data | </a> Edit Data Penduduk Pendatang</h3>
            </div>
            ...
            <form class="form-horizontal" method="POST" action="">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Datang</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kelurahan/Desa Asal</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtalamat" name="txtlurah" placeholder="Desa Asal" value="<?php echo $data['desa_asal'] ?>"  required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                  </div>
                </div>
                <div class="form-group">
        ...
        <?php
          ...
          if (isset($_POST["btnedit"])){
            ...
            $edit = mysqli_query($konek,"UPDATE  tbl_pendatang SET desa_asal='$txtlurah',kecamatan_asal='$txtkecamatan',alamat_asal='$txtalamat',tgl_datang='$txttanggal' WHERE kode='$id'");
            if ($edit)
            {
              ?>
