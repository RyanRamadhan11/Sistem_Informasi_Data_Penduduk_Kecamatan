      ...
      <div class="row">
        ...
        ?>
                                        ...
                                        <td align="left"> <?php echo $data['tgl_datang'];  ?></td>
                                         <td><a href="datang_edit.php?id=<?php echo base64_encode($data['kode']); ?>">Edit</a> | <a onClick="return confirm('Yakin Anda Menghapus ?')" href="datang_hapus.php?id=<?php echo $data['kode']; ?>">Hapus</a></td>
                                        </tr>
            <?php }}else{
      echo "Try Again";}
    ?>
