    ...
    <section class="sidebar">
        ...
        <li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="user_add.php"><i class="fa fa-user"></i> Data Admin</a></li>
            ...
            <li><a href="pekerjaan_add.php"><i class="fa fa-wrench"></i> Data Pekerjaan</a></li>
             <li><a href="lurah_add.php"><i class="fa fa-wrench"></i> Data Kelurahan/Desa</a></li>
             <li><a href="penduduk_add.php"><i class="fa fa-cubes"></i> Tambah Data Penduduk</a></li>
             <li><a href="penduduk_tampil.php"><i class="fa fa-filter"></i> Tampil Data Penduduk</a></li>
          </ul>
        </li>
      ...
      <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="laporan/penduduk_tetap.php" target="_blank"><i class="fa fa-file-pdf-o"></i>Laporan Penduduk Tetap</a></li>
            <li><a href="laporan/penduduk_pindah.php" target="_blank"><i class="fa fa-file-pdf-o"></i>Laporan Penduduk Pindah</a></li>
            <li><a href="laporan/penduduk_pendatang.php" target="_blank"><i class="fa fa-file-pdf-o"></i>Laporan Penduduk Datang</a></li>
            <li><a href="laporan/penduduk_meninggal.php" target="_blank"><i class="fa fa-file-pdf-o"></i>Laporan Penduduk Meninggal</a></li>
            <li><a href="laporan/penduduk_lahir.php" target="_blank"><i class="fa fa-file-pdf-o"></i>Laporan Penduduk Lahir</a></li>
          </ul>
        </li>
