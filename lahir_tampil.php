      ...
      <div class="row">
        ...
        ?>
                                       ...
                                       <td align="left"> <?php echo $data['nama_ayah'];  ?></td>
                                         ...
                                         <td><a href="lahir_edit.php?id=<?php echo base64_encode($data['kode']); ?>">Edit</a> | <a onClick="return confirm('Yakin Anda Menghapus ?')" href="lahir_hapus.php?id=<?php echo $data['kode']; ?>">Hapus</a></td>
                                        </tr>
            <?php }}else{
      echo "Try Again";}
    ?>
