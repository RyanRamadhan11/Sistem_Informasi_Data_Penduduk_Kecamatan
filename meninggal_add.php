        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="meninggal_tampil.php">Tampil | </a> Tambah Data Penduduk Meninggal</h3>
            </div>

            <form class="form-horizontal" method="POST" action="">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Penduduk Meninggal</label>
                  <div class="col-sm-10">
