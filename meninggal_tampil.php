 ...
 <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> <a href="meninggal_add.php">Tambah</a> | Data Penduduk Meninggal</h3>
            </div>
        ...
        ?>
                                        ...
                                        <td align="left"> <?php echo $data['tgl_kematian'];  ?></td>
                                         ...
                                         <td><a href="meninggal_edit.php?id=<?php echo base64_encode($data['kode']); ?>">Edit</a> | <a onClick="return confirm('Yakin Anda Menghapus ?')" href="meninggal_hapus.php?id=<?php echo $data['kode']; ?>">Hapus</a></td>
                                        </tr>
            <?php }}else{
      echo "Try Again";}
    ?>
