      ...
      <?php
          if (isset($_POST["btnsimpan"])){
            $txturaian =$_POST['txturaian'];
              $simpan = mysqli_query($konek,"INSERT INTO tbl_pekerjaan (uraian) VALUES ('$txturaian')");
            if ($simpan){
              ?>
              <script type="text/javascript">
                document.location.href="pekerjaan_add.php";
              </script>
              <?php
            }else{
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td><a href="pekerjaan_edit.php?id=<?php echo base64_encode($data['kode']); ?>">Edit</a> | <a onClick="return confirm('Yakin Anda Menghapus ?')" href="pekerjaan_hapus.php?id=<?php echo $data['kode']; ?>">Hapus</a></td>
                </tr>
                <?php } ?>
