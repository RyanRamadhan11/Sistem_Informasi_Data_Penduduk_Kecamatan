        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Input Data Pendidikan</h3>
            </div>
            <form class="form-horizontal" method="POST" action="">
              <div class="box-body">
             
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Tingkat Pendidikan *</label>
                  <div class="col-sm-10">
          ...
          if (isset($_POST["btnsimpan"])){
            $txturaian =$_POST['txturaian'];
              $simpan = mysqli_query($konek,"INSERT INTO tbl_pendidikan (uraian) VALUES ('$txturaian')");
            if ($simpan){
              ?>
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td><a href="pendidikan_edit.php?id=<?php echo base64_encode($data['kode']); ?>">Edit</a> | <a onClick="return confirm('Yakin Anda Menghapus ?')" href="pendidikan_hapus.php?id=<?php echo $data['kode']; ?>">Hapus</a></td>
                </tr>
                <?php } ?>
              </table>
            </div>
