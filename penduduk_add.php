       ...
       <div class="col-md-6">
          <div class="box box-succsess">
            <div class="box-header with-border">
              <h3 class="box-title">Form Input Data Penduduk</h3>
            </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" maxlength="16" class="form-control" name="txtnik" placeholder="Input NIK" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                   ...
                   <div class="form-group">
                  <label>Nama *</label>
                  <input type="text" class="form-control" name="txtnama" placeholder="Input Nama" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                </div>
                   <div class="form-group">
                  <label>Tempat Lahir *</label>
                  <input type="text" class="form-control" name="txttempatlahir" placeholder="Input Tempat Lahir" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                </div>


                   <div class="form-group">
                  <label>Tanggal Lahir *</label>
                  <input type="date" class="form-control" id="date" name="txttanggal" placeholder="Input Tanggal Lahir" required oninvalid="this.setCustomValidity('Tidak Boleh Kosong')" oninput="setCustomValidity('')" />
                </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Data Penduduk Kecamatan Cilamaya</h3>
            </div>
