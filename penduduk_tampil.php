 ...
 <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><a href="penduduk_add.php">Tambah</a>  |  Data Penduduk Kecamatan Cilamaya</h3>
            </div>
        ...
        ?>
                                        ...
                                        <td align="left"> <?php echo $data['jenis'];  ?></td>
                                         ...
                                         <td width="15%"><a href="penduduk_edit.php?id=<?php echo base64_encode($data['kode']); ?>">Edit</a> | <a onClick="return confirm('Yakin Anda Menghapus ?')" href="penduduk_hapus.php?id=<?php echo $data['kode']; ?>">Hapus</a> 
                                          <a href="profil.php?id=<?php echo base64_encode($data['kode']); ?>"> <button class="btn btn-primary">Detail</button> </a></td>
                                        </tr>
            <?php }}else{
      echo "Try Again";}
    ?>
