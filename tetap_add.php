      ...
      <br>
        ...
        <div class="col-xs-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Data Penduduk Tetap</h3>
            </div>
            <div class="box-body">
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-default">
              Tambah Penduduk Tetap
              </button>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        ?>
                                        ...
                                        <td align="left"> <?php echo $data['alamat'];  ?></td>
                                         ...
                                         <td><a onClick="return confirm('Yakin Anda Menghapus ?')" href="tetap_hapus.php?id=<?php echo $data['kode']; ?>">Hapus</a></td>
                                        </tr>
            <?php }}else{
      echo "Try Again";}
    ?>
